...
<html lang="">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="col-lg-12">
				<legend><center>Update Data Pegawai</center></legend>
				<?php echo form_open('Admin/edit/'.$this->uri->segment(3)); ?>
				<?php echo validation_errors() ?>
					<div class="form-group">
						<?php foreach ($sdm as $key) { ?>
							<label for="">Nama</label>
							<input type="text" class="form-control" id="" placeholder="Nama" name="nama" value="<?php echo $key->nama ?>">

							<label for="">Username</label>
							<input type="text" class="form-control" id="" placeholder="Username" name="username" value="<?php echo $key->username ?>">

							<label for="">Password</label>
							<input type="password" class="form-control" id="" placeholder="Password" name="password" value="<?php echo $key->password ?>">

							<label for="">Alamat</label>
							<input type="text" class="form-control" id="" placeholder="Alamat" name="alamat" value="<?php echo $key->alamat ?>">

							<label for="">No HP</label>
							<input type="text" class="form-control" id="" placeholder="No HP" name="no_hp" value="<?php echo $key->no_hp ?>">
						<?php } ?>
					</div>
