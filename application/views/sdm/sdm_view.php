	...
	<body>
		<div class="container-fluid">
			...
			<div class="col-lg-12">
				...
				<a class="btn btn-default" href="<?php echo site_url('Admin/create') ?>">Tambah Data</a>
					...
					<tbody>
						<?php foreach ($sdm as $key) { ?>
							<tr>
								...
								<td><a class="btn btn-primary" href="<?php echo site_url('Admin/edit/'.$key->id_user) ?>">Edit</a>
								<a class="btn btn-danger" href="<?php echo site_url('Admin/delete/'.$key->id_user) ?>">Delete</a>
								</td>
							</tr>
						<?php } ?>
					</tbody>
