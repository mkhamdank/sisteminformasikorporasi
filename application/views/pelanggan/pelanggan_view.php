...
<html lang="">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="col-lg-12">
				<legend><center>Data Pelanggan</center></legend>
					...
					<tbody>
						<?php foreach ($pelanggan as $key) { ?>
							<tr>
								...
								<td><a class="btn btn-primary" href="<?php echo site_url('Pelanggan/edit/'.$key->id_pelanggan) ?>">Edit</a>
								<a class="btn btn-danger" href="<?php echo site_url('Pelanggan/delete/'.$key->id_pelanggan) ?>">Delete</a>
								</td>
							</tr>
						<?php } ?>
					</tbody>
