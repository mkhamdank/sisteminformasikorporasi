...
<html lang="">
	...
	<body>
		<div class="container-fluid">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse navbar-ex1-collapse">
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="<?php echo site_url('Produksi') ?>">Produski</a></li>
			...
			<div class="col-lg-12">
				<legend><center>Edit Data Produksi</center></legend>
				<?php echo form_open('Produksi/edit/'.$this->uri->segment(3)); ?>
					<div class="form-group">
						<?php foreach ($produksi as $key) { ?>
							<label for="">Bahan</label>
							<select name="fk_bahan" id="inputFk_supplier" class="form-control">
								<option value="<?php echo $key->id_bahan ?>">--- <?php echo $key->nama_bahan ?> ---</option>
								<?php foreach ($bahan as $val) { ?>
									<option value="<?php echo $val->id_bahan ?>"><?php echo $val->nama_bahan ?></option>
								<?php } ?>
							</select>

							<label for="">Tanggal Produksi</label>
							<input type="date" name="tanggal_produksi" id="inputTanggal_produksi" class="form-control" value="<?php echo $key->tanggal_produksi ?>" title="">
							<label for="">Jumlah</label>
							<input type="text" name="jumlah" id="inputJumlah" class="form-control" placeholder="Jumlah" title="" value="<?php echo $key->jumlah_produksi ?>">
						<?php } ?>
					</div>
