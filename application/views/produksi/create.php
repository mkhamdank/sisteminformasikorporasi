...
<html lang="">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="col-lg-12">
				<legend><center>Tambah Data Produksi</center></legend>
				<?php echo form_open('Produksi/create'); ?>
					<div class="form-group">
						...
						<input type="text" name="jumlah" id="inputJumlah" class="form-control" value="" placeholder="Jumlah" title="">
					</div>
