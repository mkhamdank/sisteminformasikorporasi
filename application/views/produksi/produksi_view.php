...
<html lang="">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="col-lg-12">
				<legend><center>Data Produksi</center></legend>
				<a class="btn btn-default" href="<?php echo site_url('Produksi/create') ?>">Tambah Data</a>
					...
					<tbody>
						<?php foreach ($produksi as $key) { ?>
							<tr>
								...
								<td><a class="btn btn-primary" href="<?php echo site_url('Produksi/edit/'.$key->id_produksi) ?>">Edit</a>
								<a class="btn btn-danger" href="<?php echo site_url('Produksi/delete/'.$key->id_produksi) ?>">Delete</a>
								</td>
							</tr>
						<?php } ?>
					</tbody>
