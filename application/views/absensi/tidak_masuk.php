...
<html lang="">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="col-lg-12">
				<legend><center>Tambah Data Pegawai Tidak Masuk</center></legend>
				<?php echo form_open('Absensi/tidak_masuk'); ?>
				...
				<p align="right">Tanggal : <?php echo date("d-m-Y") ?></p>
					<div class="form-group">
						...
						<input type="text" name="keterangan" id="inputHidden" class="form-control" placeholder="Keterangan">
					</div>
