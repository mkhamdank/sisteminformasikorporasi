...
<html lang="">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="col-lg-12">
				<legend><center>Update Data Penggajian</center></legend>
				<?php echo form_open('Penggajian/edit/'.$this->uri->segment(3)); ?>
				<?php echo validation_errors() ?>
					<div class="form-group">
						<?php foreach ($penggajian as $val) { ?>
							...
							<input type="text" class="form-control" id="" placeholder="Gaji" name="gaji" value="<?php echo $val->gaji ?>">

							<label for="">Tunjangan</label>
							<input type="text" class="form-control" id="" placeholder="Tunjangan" name="tunjangan" value="<?php echo $val->tunjangan ?>">

							<label for="">Tanggal</label>
							<input type="date" class="form-control" id="" placeholder="Tanggal" name="tanggal" value="<?php echo $val->tanggal ?>">

							<label for="">Keterangan</label>
							<input type="text" class="form-control" id="" placeholder="Keterangan" name="keterangan" value="<?php echo $val->keterangan ?>">
						<?php } ?>
					</div>
