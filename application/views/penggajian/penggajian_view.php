...
<html lang="">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="col-lg-12">
				<legend><center>Data Penggajian</center></legend>
				<a class="btn btn-default" href="<?php echo site_url('Penggajian/create') ?>">Tambah Data</a>
					...
					<tbody>
						<?php foreach ($penggajian as $key) { ?>
							<tr>
								...
								<td><a class="btn btn-primary" href="<?php echo site_url('Penggajian/edit/'.$key->id_gaji) ?>">Edit</a>
								<a class="btn btn-danger" href="<?php echo site_url('Penggajian/delete/'.$key->id_gaji) ?>">Delete</a>
								</td>
							</tr>
						<?php } ?>
					</tbody>
