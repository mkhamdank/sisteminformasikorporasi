...
<html lang="">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="col-lg-12">
				<legend><center>Edit Data Lembur</center></legend>
				<?php echo form_open('lembur/edit/'.$this->uri->segment(3)); ?>
				<?php echo validation_errors(); ?>
					<div class="form-group">
						<?php foreach ($lembur as $val) { ?>
							<label for="">Pegawai</label>
							<select name="fk_user" id="inputFk_user" class="form-control">
							...
							<input type="date" name="tanggal_lembur" id="inputTanggal_lembur" class="form-control" value="<?php echo $val->tanggal_lembur ?>" title="">

							<label for="">Waktu Lembur</label>
							<input type="text" name="waktu" id="inputTanggal_lembur" class="form-control" value="<?php echo $val->waktu ?>" title="">
						<?php } ?>
					</div>
