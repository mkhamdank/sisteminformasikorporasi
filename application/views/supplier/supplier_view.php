...
<html lang="">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="col-lg-12">
				<legend><center>Data Supplier</center></legend>
				<a class="btn btn-default" href="<?php echo site_url('Supplier/create') ?>">Tambah Data</a>
				<table class="table table-hover">
					<thead>
						<tr>
							<th>Nama Lengkap Supplier</th>
							<th>Alamat</th>
							<th>Nomor HP</th>
							<th>Action</th>
						</tr>
					...
					<tbody>
						<?php foreach ($supplier as $key) { ?>
							<tr>
								...
								<td><a class="btn btn-primary" href="<?php echo site_url('Supplier/edit/'.$key->id_supplier) ?>">Edit</a>
								<a class="btn btn-danger" href="<?php echo site_url('Supplier/delete/'.$key->id_supplier) ?>">Delete</a>
								</td>
							</tr>
						<?php } ?>
					</tbody>
