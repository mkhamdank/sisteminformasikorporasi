...
<html lang="">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="col-lg-12">
				<legend><center>Edit Data Supplier</center></legend>
				<?php echo form_open('Supplier/edit/'.$this->uri->segment(3));?>
				<?php echo validation_errors(); ?>
				<div class="form-group" style="color:black;">
					<?php foreach ($supplier as $key) { ?>
						<label for="">Nama Supplier</label>
						<input type="text" name="nama_supplier" class="form-control" id="nama_produk" placeholder="Nama Supplier" value="<?php echo $key->nama_supplier ?>">
