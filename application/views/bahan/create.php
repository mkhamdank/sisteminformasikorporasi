...
<html lang="">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="col-lg-12">
				<legend><center>Tambah Data Bahan</center></legend>
				<?php echo form_open('Bahan/create');?>
				<?php echo validation_errors(); ?>
				<div class="form-group" style="color:black;">
					<label for="">Nama Bahan</label>
					<input type="text" name="nama_bahan" class="form-control" id="nama_produk" placeholder="Nama Bahan">
					
					<label for="">Jumlah</label>
					<input type="text" name="jumlah" class="form-control" id="jumlah" placeholder="Jumlah">
					
					<label for="">Harga Satuan</label>
					<input type="text" name="harga_satuan" class="form-control" id="harga" placeholder="Harga Satuan">

					<label for="">Expired (hari)</label>
					<input type="text" name="expired" class="form-control" id="harga" placeholder="Expired">
					<br>
