...
<html lang="">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="col-lg-12">
				<legend><center>Data Bahan</center></legend>
				<a class="btn btn-default" href="<?php echo site_url('Bahan/create') ?>">Tambah Data</a>
					...
					<tbody>
						<?php foreach ($bahan as $key) { ?>
							<tr>
								...
								<td><a class="btn btn-primary" href="<?php echo site_url('Bahan/edit/'.$key->id_bahan) ?>">Edit</a>
								<a class="btn btn-danger" href="<?php echo site_url('Bahan/delete/'.$key->id_bahan) ?>">Delete</a>
								</td>
							</tr>
						<?php } ?>
					</tbody>
