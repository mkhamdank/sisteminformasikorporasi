...
<html lang="">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="col-lg-12">
				<legend><center>Edit Data Pengeluaran</center></legend>
				<?php echo form_open('Pengeluaran/edit/'.$this->uri->segment(3)); ?>
					<div class="form-group">
						<?php foreach ($pengeluaran as $value) { ?>
							...
							<select name="fk_supplier" id="inputFk_supplier" class="form-control">
							...
							<input type="text" name="jumlah_beli" id="inputJumlah_beli" class="form-control" value="<?php echo $value->jumlah_beli ?>">

							<label for="">Tanggal</label>
							<input type="date" name="tanggal" id="inputJumlah_beli" class="form-control" value="<?php echo $value->tanggal ?>">
						<?php } ?>
					</div>
