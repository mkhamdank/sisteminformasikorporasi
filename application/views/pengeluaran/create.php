...
<html lang="">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="col-lg-12">
				<legend><center>Tambah Data Pengeluaran</center></legend>
				<?php echo form_open('Pengeluaran/create'); ?>
				<?php echo validation_errors() ?>
					<div class="form-group">
						...
						<input type="text" name="jumlah_beli" id="inputJumlah_beli" class="form-control" value="" placeholder="Jumlah Beli">

						<label for="">Tanggal</label>
						<input type="date" name="tanggal" id="inputJumlah_beli" class="form-control" value="">
					</div>
