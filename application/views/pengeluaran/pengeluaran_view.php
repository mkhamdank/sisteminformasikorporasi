...
<html lang="">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="col-lg-12">
				<legend><center>Data Pengeluaran</center></legend>
				<a class="btn btn-default" href="<?php echo site_url('Pengeluaran/create') ?>">Tambah Data</a>
				<table class="table table-hover">
					<thead>
						<tr>
							<th>Nama Supplier</th>
							<th>Bahan</th>
							<th>Pegawai yang Bertanggungjawab</th>
							<th>Jumlah Beli</th>
							<th>Total Harga</th>
							<th>Tanggal Beli</th>
					...
					<tbody>
						<?php foreach ($pengeluaran as $key) { ?>
							<tr>
								...
								<td><a class="btn btn-primary" href="<?php echo site_url('Pengeluaran/edit/'.$key->id_pengeluaran) ?>">Edit</a>
								<a class="btn btn-danger" href="<?php echo site_url('Pengeluaran/delete/'.$key->id_pengeluaran) ?>">Delete</a>
								</td>
							</tr>
						<?php } ?>
					</tbody>
