		...
		<div class="container-fluid">
			...
			<div class="col-lg-12">
				...
				<div class="form-group" style="color:black;">
					...
					<input type="text" name="nama_produk" class="form-control" id="nama_produk" placeholder+"field">
					
					<label for="">Stok Produk</label>
					<input type="text" name="jumlah" class="form-control" id="jumlah" placeholder+"fielad">
					
					<label for="">Harga Satuan</label>
					<input type="text" name="harga" class="form-control" id="harga" placeholder+"field">
