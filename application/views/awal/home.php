            ...
            <?php foreach ($produk as $key) { ?>
            	<div class="col-lg-4 col-md-6 mb-4">
	                <div class="card h-100">
	                  <a class="MagicZoom" href="<?=base_url("assets/uploads")."/".$key->Gambar?>" rel="zoom-id:zoom;opacity-reverse:true;"> <img class="card-img-top" src="<?=base_url("assets/uploads")."/".$key->Gambar ?>" alt="" height="150px"></a>
	                  <div class="card-body">
	                    <h4 class="card-title">
	                      <?php echo $key->nama_produk ?>
	                    </h4>
	                    <h5><?php echo $key->harga ?></h5>
                      Stok : <?php echo $key->jumlah ?>
	                    <p class="card-text"></p>
	                  </div>
